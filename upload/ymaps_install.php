<?php
// Первым делом подключаем DLE_API как это ни странно, но в данном случае это упрощает жизнь разработчика.
...
<div class="descr">
	...
	<p>Предварительная правка файлов для установки модуля не требуется.</p>
	<p>Инструкция по настройке модуля находится на странице с документацией: <a href="http://maps.pafnuty.name/documentation/#setup" target="_blank">http://maps.pafnuty.name/documentation/#setup</a></p>
</div>
HTML;
...
<body>
	...
	<div>
		Контакты: <br>
		<a href="https://github.com/dle-modules/DLE-YandexMaps" target="_blank">DLE-YandexMaps</a> — Репозиторий модуля <br>
		<a href="https://github.com/dle-modules/DLE-YandexMaps/issues/new" target="_blank">Техподдержка</a>
	</div>
